...
![Interactive prototype: Testing real-time capture during live calls.](/project-imgs/loop-note/proto-notes.webp)
...
![Testing: Identifying cognitive friction in complex panels.](/project-imgs/loop-note/iteration-03.webp)
...
![Final design: A document-centric view that prioritizes focus and ease of use.](/project-imgs/loop-note/updated-note.webp)

![Editor View: The final high-fidelity note-taking workspace.](/project-imgs/loop-note/loop-note-notes.webp)
...
![Researcher Workflow: Task-based scripts.](/project-imgs/loop-note/task-2.png)
...
![Integrated Workflow: Scripts surfaced directly within the synthesis editor.](/project-imgs/loop-note/editor-question.webp)
